...
import { T_Pagination, T_FilterParams, T_Sorter } from "@/types";
...
export const generateCrudStore = (
  ...
  return defineStore({
    ...
    actions: {
      ...
      async createNewData(payload = {}, customUrl = "") {
        this.loading = true;
      ...
      async putUpdate(payload = {}, customUrl = "") {
        this.loading = true;
        const url: string = customUrl || apiUrl;
        try {
      ...
      async patchUpdate(payload = {}, customUrl = "") {
        this.loading = true;
        const url: string = customUrl || apiUrl;
        try {
      ...
      async deleteData(payload = {}, customUrl = "") {
        this.loading = true;
      ...
      deleteQuery(key: string) {
        ...
        queryObj.value[key] && delete queryObj.value[key];
        this.queryString = setQueryString(queryObj.value);
      },
